...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<minitar>.freeze, ["~> 0.9.0".freeze])
  ...
  s.add_development_dependency(%q<minitest-autotest>.freeze, [">= 1.0".freeze, "< 2".freeze])
  s.add_development_dependency(%q<rake>.freeze, ["< 14".freeze])
